...
const BannerImage =
  "https://firebasestorage.googleapis.com/v0/b/quickconnect78.appspot.com/o/blog%20banner%20(1).png?alt=media&token=dbbe8e05-141d-4283-bd1c-6b06c585d15a";
const PopupEditor = ({ editorc }) => {
  ...
  const isPublishDisabled = () => {
    ...
    // Check if content length is at least 20 letters
    const isContentValid = content.length >= 20;
  
    // Return true if any condition is not met
    return !isTitleValid || !isTagValid || !isContentValid;
  };
